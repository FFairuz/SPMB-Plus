...
<?= $this->section('title'); ?>Tambah Konten Home<?= $this->endSection(); ?>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="mb-1 fw-bold">Tambah Konten Home</h3>
        <p class="text-muted mb-0">Buat konten baru untuk halaman home</p>
    </div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="<?= base_url('admin/content-management/store') ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="section" name="section" required>
                        ...
                        <option value="hero" <?= old('section') == 'hero' ? 'selected' : '' ?>>Hero Banner</option>
                        <option value="about" <?= old('section') == 'about' ? 'selected' : '' ?>>Tentang Kami</option>
                        <option value="features" <?= old('section') == 'features' ? 'selected' : '' ?>>Fitur/Keunggulan</option>
                        <option value="testimonials" <?= old('section') == 'testimonials' ? 'selected' : '' ?>>Testimoni</option>
                        <option value="gallery" <?= old('section') == 'gallery' ? 'selected' : '' ?>>Galeri</option>
                        <option value="contact" <?= old('section') == 'contact' ? 'selected' : '' ?>>Kontak</option>
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control" id="content" name="content" rows="5"
                              placeholder="Masukkan deskripsi atau konten detail"><?= old('content') ?></textarea>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="button_text" name="button_text" 
                           value="<?= old('button_text') ?>" maxlength="100"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="button_link" name="button_link" 
                           value="<?= old('button_link') ?>" maxlength="255"
