...
<?= $this->section('title'); ?>Tambah Jurusan<?= $this->endSection(); ?>

<?= $this->section('content'); ?>
<h2 class="mb-3">
    <i class="bi bi-plus-circle"></i> Tambah Jurusan Baru
</h2>
...
<!-- Form -->
<form method="post" action="/admin/majors/create" class="card border-0 shadow-sm p-4">
    <?= csrf_field(); ?>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <button type="submit" class="btn btn-primary btn-lg me-2">
                <i class="bi bi-check-circle"></i> Simpan Jurusan
            </button>
