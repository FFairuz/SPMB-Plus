...
<head>
    ...
    <title>Bukti Pembayaran SPMB - <?= esc($payment['nama_lengkap'] ?? 'Siswa') ?></title>
    <style>
        @page {
...
<body>
    <!-- Print & Back Buttons -->
    <a href="<?= base_url('bendahara/verifikasi-pembayaran') ?>" class="back-button no-print">
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-header">
            ...
            <h2><?= function_exists('school_name') ? esc(school_name()) : 'SMK MUHAMMADIYAH 1 JAKARTA' ?></h2>
        ...
        <div class="receipt-body">
            ...
            <div class="payment-box">
                ...
                <div class="payment-amount">
                    Rp. <?= number_format($payment['transfer_amount'] ?? $payment['registration_fee'] ?? 0, 0, ',', '.') ?>
                </div>
                <div class="payment-label">Terbilang</div>
                <div class="payment-words">
                    " <?= ucwords(terbilang($payment['transfer_amount'] ?? $payment['registration_fee'] ?? 0)) ?> rupiah "
                </div>
            </div>
            ...
            <div class="signature-section">
                <div class="signature-box">
                    ...
                    <div class="signature-name">
                        <?php
                        // Get petugas name from session or payment
